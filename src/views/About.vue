<template>
  ...
  <div class="hidden">
    ...
    <p>
      ...
      <a
        href="https://www.formation-cci.fr/formations-professionnelles/toutes-les-formations/901-decouverte-multimedia-pole-emploi"
      ></a>
      Suite à une quizaine d'années dans la restauration, j'ai décider de commencer une
      réorientation professionnel car les métiers de la restauration ne me convenais plus.
      Ne sachant pas vers quel domaine me diriger, j'ai enchaîner différentes emplois
      alimentaires dans l'hôtellerie, le paysagisme et l'horticulture. C'est au cours
      d'une période de chômage que j'ai eu l'opportunité d'effectuer une
      <a
        href="https://www.formation-cci.fr/formations-professionnelles/toutes-les-formations/901-decouverte-multimedia-pole-emploi"
        >formation "découverte Multimédia" avec la CCI d'Annecy</a
      >. Au cours de cette formation, j'ai découvert les métiers du digital ou j'ai pu me
      perfectionner dans des logiciels de la suite Adobe (Photoshop, Illustrator et Adobe
      XD), décrouvrir le Référencement naturel et son importance dans sur le Web et j'ai
      tapper mes premières lignes de code <strong>HTML 5</strong> et
      <strong>CSS 3</strong>. Cette formation m'a permis de rencontrer plusieurs
      professionnels du web qui ont finis de me convaincre de continuer vers le
      <strong>Web Design</strong> et le Développement. J'ai donc chercher activement à me
      former dans le Devéloppement Web et j'ai pu intégrer la première session de
